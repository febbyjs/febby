...
exports.buildProjection =
  ...
  exports.putHandler =
  exports.postHandler =
  exports.removeByIdHandler =
  exports.getByIdHandler =
  exports.register =
  exports.buildRedisKey =
  exports.validateAppConfig =
    void 0;
...
async function getByIdHandler(req, res, next) {
  ...
  const projection = (
    (_b = req.query) === null || _b === void 0 ? void 0 : _b.projection
  )
    ? buildProjection(
        (_c = req.query) === null || _c === void 0 ? void 0 : _c.projection
      )
    : "";
  let doc = null;
  if (febby.redis) {
...
async function getHandler(req, res, next) {
  ...
  const model = res.app.get("collection");
  const skip = ((_a = req.query) === null || _a === void 0 ? void 0 : _a.skip)
    ? parseInt(
        (_b = req.query) === null || _b === void 0 ? void 0 : _b.skip,
        10
      )
    : 0;
  const limit = ((_c = req.query) === null || _c === void 0 ? void 0 : _c.limit)
    ? parseInt(
        (_d = req.query) === null || _d === void 0 ? void 0 : _d.limit,
        10
      )
    : 10;
  const projection =
    (
      ((_e = req.query) === null || _e === void 0 ? void 0 : _e.projection) ||
      ""
    ).length > 0
      ? buildProjection(
          (_f = req.query) === null || _f === void 0 ? void 0 : _f.projection
        )
      : {};
  try {
    const query = (
      (_g = req.query) === null || _g === void 0 ? void 0 : _g.query
    )
      ? JSON.parse(
          (_h = req.query) === null || _h === void 0 ? void 0 : _h.query
        )
      : {};
